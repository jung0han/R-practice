...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(
    ...
    menuItem("Corona Table", tabName = "corona-table", icon = icon("table")),
    br(),
    fluidRow(
      column(
        width = 11,
...
body <- dashboardBody(
  ...
  tabItems(
    ...
    source("ui/03-corona-claims-ui.R", local = TRUE)$value,
    #source("ui/01-corona-dashboard-ui.R", local = TRUE)$value#,
