...
# install.packages(c("shiny", "shinydashboard", "tibble", "dplyr", "highcharter", "DT", "lubridate", "tidyr", "shinyWidgets", "openxlsx", "officer", "flextable"))
...
loss_corona_run <- function(val_date, trans_ = coronavirus) {
  trans_ %>%
